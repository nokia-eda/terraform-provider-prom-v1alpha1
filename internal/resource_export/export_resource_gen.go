		...
		Attributes: map[string]schema.Attribute{
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^prom\\.eda\\.nokia\\.com/v1alpha1$"), ""),
				},
				Default: stringdefault.StaticString("prom.eda.nokia.com/v1alpha1"),
			},
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"exports": schema.ListNestedAttribute{
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"destination": schema.StringAttribute{
												...
												Validators: []validator.String{
													stringvalidator.RegexMatches(regexp.MustCompile("^-?\\d+(\\.\\d+)?([eE][+-]?\\d+)?$"), ""),
												},
											},
						...
						MarkdownDescription: "Exports is the list of metrics and their sources to be exposed to Prometheus",
					},
					"group": schema.StringAttribute{
						Optional:            true,
