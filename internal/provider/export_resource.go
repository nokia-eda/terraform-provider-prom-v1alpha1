...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-prom/internal/resource_export"
	"github.com/nokia/eda/apps/terraform-provider-prom/internal/tfutils"
)

const (
	create_rs_export = "/apps/prom.eda.nokia.com/v1alpha1/exports"
	read_rs_export   = "/apps/prom.eda.nokia.com/v1alpha1/exports/{name}"
	update_rs_export = "/apps/prom.eda.nokia.com/v1alpha1/exports/{name}"
	delete_rs_export = "/apps/prom.eda.nokia.com/v1alpha1/exports/{name}"
)
...
func (r *exportResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_export, nil, reqBody, &result)
