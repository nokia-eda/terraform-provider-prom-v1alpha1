...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-prom/internal/eda/apiclient"
	"github.com/nokia/eda/apps/terraform-provider-prom/internal/eda/utils"
	"github.com/nokia/eda/apps/terraform-provider-prom/internal/tfutils"
)
...
var _ provider.Provider = (*promProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &promProvider{version: ver}
	}
}
...
func (p *promProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *promProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *promProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "prom-v1alpha1"
	resp.Version = p.version
}

func (p *promProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
...
func (p *promProvider) Resources(ctx context.Context) []func() resource.Resource {
