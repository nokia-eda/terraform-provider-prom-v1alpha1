---
page_title: "prom-v1alpha1 Provider"
---

# prom-v1alpha1 Provider

This provider is used to interact with the resources provided by the **prom-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
